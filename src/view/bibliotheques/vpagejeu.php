  ...
  <main>
      ...
      <div class="flex pt-5">
        <div class="flex-col w-2/3">
          <div class="flex">
            ...
            <div class="bg-[#f45a01]/95 rounded-full text-[#f1f7f9] font-['Open Sans'] text-center text-[0.875em] font-semibold h-20 pt-2 m-4 w-2/3">
              ...
              <input type="text" id="nom" name="nom" placeholder="Saisissez ici" class="hover:bg-white hover:text-black rounded-full mt-2 border focus:border-purple-800 focus:border-2" />
            </div>
          </div>
          ...
          <div class="flex">
            <div class="bg-[#f45a01]/95 rounded-full text-[#f1f7f9] text-center text-[0.875em] font-semibold pt-2 m-4 pb-5 w-full">
              ...
              <textarea id="resume" name="resume" placeholder="Saisissez ici" rows="15" cols="150" class="hover:bg-white hover:text-black rounded-full m-4 pt-2 w-[90%] resize-y border focus:border-purple-800 focus:border-2"></textarea>
            </div>
          </div>
        </div>
        ...
        <aside class="flex-col w-1/3">
          ...
          <div class="bg-[#f45a01]/95 rounded-full text-center text-[0.875em] font-semibold p-2 m-4">
            ...
            <input type="text" id="editeur" name="editeur" placeholder="Saisissez ici" class="hover:bg-white hover:text-black rounded-full mt-1 border focus:border-purple-800 focus:border-2" />
          </div>

          <div class="bg-[#f45a01]/95 rounded-full text-center text-[0.875em] font-semibold p-2 m-4">
            <label for="studio">Studio :</label><br>
            <input type="text" id="studio" name="studio" placeholder="Saisissez ici" class="hover:bg-white hover:text-black rounded-full mt-1 border focus:border-purple-800 focus:border-2" />
          </div>
          ...
          <div class="bg-[#f45a01]/95 rounded-full text-center text-[0.875em] font-semibold p-2 m-4">
            ...
            <input class="form-checkbox h-2 w-2 bg-white cursor-pointer checked:bg-blue-500" type="radio" id="optionMulti1" name="optionsM" value="oui">
            <label for="optionMulti2">Non</label>
            <input class="form-checkbox h-2 w-2 bg-white cursor-pointer checked:bg-blue-500" type="radio" id="optionMulti2" name="optionsM" value="non">
          </div>
    ...
    <div class="flex justify-center w-full">
      <form method="post" action="<?= APP_ROOT ?>/page-jeu/delete-jeu">
        ...
        <button class="font-['Changa'] text-[#f1f7f9] bg-[#f45a01]/95 rounded-full w-[20%] text-center text-[1.06em] p-2 m-5 ring ring-offset-2 ring-purple-500 ring-offset-purple-100/30 hover:ring-green-500 hover:ring-offset-green-500 shadow-lg shadow-indigo-500/50 hidden" type="submit" name="submit">
          Valider
        </button>
      </form>
    </div>
